...
use ATUserBundle\Entity\ContactGroup;
...
class ContactManager
{
     ...
     * @return array|null
     */
    public function getUserContactEmailsForAutocomplete(User $user)
    {
        $emails = array();
        /** @var User $user */
        foreach ($user->getContactsListAsUser() as $user) {
     ...
     * @return mixed
     */
    public function getFilteredContactsOfUser(User $user, $search = null, $nbResult = 10, $pageIdx = 1, $sorts = array())
    {
     ...
     * @param User $owner L'utilisateur a qui ajouter le contact
     ...
     */
    public function addContact(User $owner, $userLinkedId)
    {
